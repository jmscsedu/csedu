...
\begin{document}
	...
	\section*{Activity \#1}
		...
		\subsection{Exercise}
			...
			\begin{itemize}
				...
				\item The \code{binaryToString()}, \code{stringToBinary()}, and \code{XORStrings()} helper methods useful for the encryption and decryption process.
	...
	\section{Final Analysis}
		...
		\ \\[9pt]
		\QBox{Private key encryption such as the RSA method described relies on a the mathematical idea that multiplication is easy, but prime factorization is hard. Why might this be a weakness in light of recent computing innovations?}{4cm}
		\ \\[9pt]
