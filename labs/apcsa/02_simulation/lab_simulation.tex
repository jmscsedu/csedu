...
\begin{document}
	...
	\section{Activity \#1}
		\subsection{Introduction}
			In this activity, you will create a Java program simulating the situation presented in the background. In particular, your simulation will calculate the number of guests who have heard the rumour about Alice before it stops propagating.
...
\pagebreak
	...
	\begin{tabular} {*{4}{*{3}{| >{\bfseries\centering}p{0.0575\textwidth}}}|}
		...
		\hline
		Q01 & 1 & \ & EX1 & 7 & \ & EX1 & 6 & \ & Q09 & 1 & \ \tabularnewline
		\hline
		Q02 & 1 & \ & EX2 & 2 & \ & EX2 & 3 & \ & Q10 & 1 & \ \tabularnewline
		\hline
