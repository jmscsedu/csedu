...
\begin{document}
  \begin{questions}
    ...
    \RedQuestion{\emph{Longest Plateau.} Given an array of integers, find the length and location of the longest contiguous sequence of equal values where the values of the elements just before and just after the sequence are smaller.}
  \end{questions}
\end{document}
