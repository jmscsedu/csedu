...
\begin{document}
  \begin{questions}
    %Errors
    \BlueQuestion{Why do you think it is considered ``good practice'' to place the \code{size()} command before any other drawing commands in Processing?}
    ...
    \YellowQuestion{Explain the iterative and incremental steps you took to create your Processing Bee program.}
  \end{questions}
\end{document}
