...
\begin{document}
  \begin{questions}
    ...
    \RedQuestion{Use the Processing reference for the \code{arc()} drawing method (https://processing.org/reference/arc\_.html) to assist you in emulating the following image of a dartboard.\\
          ...
          {\small\textbf{Hint:} Because there are $20$ different ``wedges'' in the dart board, each arc should be $\frac{\pi}{5}$ radians wide. The value of $\pi$ is accessible via the \code{PI} keyword in Processing.}
          \begin{center}
